  ...
  return (
    <main className="flex-grow flex flex-col items-center justify-center px-screen-gutter relative z-10 w-full max-w-md mx-auto min-h-screen pt-12 pb-safe bg-ink">
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-volt-dim blur-[100px] opacity-20"></div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center w-full space-y-section-v-rhythm text-center flex-grow z-10">
        <div className="flex flex-col items-center space-y-4">
          <ArrowLeft className="text-volt w-8 h-8" strokeWidth={2.5} />
        ...
        <div className="w-full aspect-square max-w-[280px] my-8 relative flex items-center justify-center">
          <div className="absolute inset-0 rounded-3xl hairline-border bg-surface shadow-[0_0_40px_rgba(244,228,9,0.08)]"></div>
          <div className="relative z-10 w-24 h-24 rounded-full bg-volt-dim border-2 border-volt flex items-center justify-center">
            <RefreshCcw className="text-volt w-12 h-12" strokeWidth={2} />
          </div>
        </div>
      </div>
      ...
      <div className="w-full flex flex-col items-center space-y-6 mt-8 pb-8 z-10">
        <button
          ...
          className="w-full bg-volt text-ink rounded-full py-4 px-6 text-stat-value hover:bg-volt-press active:scale-[0.97] transition-all flex items-center justify-center space-x-2"
        >
